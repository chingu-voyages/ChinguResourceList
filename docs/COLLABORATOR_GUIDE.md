...
As a collaborator you will be adding and updating content to be share with
others involved in Development activity from across the globe. This guide will 
help you understand your role and the responsibilities that come with being a 
collaborator.

1. __Adhere to and help enforce the Code of Conduct.__ It is expected that you
have read the [code of conduct](https://github.com/chingu-voyages/MegaResourceList/blob/development/docs/CODE_OF_CONDUCT.md)
